...
int main()
{
  ...
  app.loadTexture2D(ASSETS_2D_BASEPATH + "/brickwall.jpg", 1);
  app.loadTexture2D(ASSETS_2D_BASEPATH + "/brickwall_normal.jpg", 2);

  handcraftQuad(&app);

  Shader tbnShader(getExecutablePath() + "/tbn.vs", getExecutablePath() + "/tbn.fs");
