...
int main()
{
    ...
    // ------------------------------------------------------------------
    float firstTriangle[] = {
        -0.9f, -0.5f, 0.0f, 1, 0, 0, // left 
        -0.0f, -0.5f, 0.0f, 0, 1, 0, // right
        -0.45f, 0.5f, 0.0f, 0, 0, 1,// top 
    };
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, (3+3) * sizeof(float), (void*)0);	// Vertex attributes stay the same
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        float yellowValue = (std::sin(timeValue) / 2.0f) + 0.5f;
